...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_userprofile', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='tyrion_profile', unique=True, to=orm['auth.User'])),
        ))
    ...
    models = {
        u'accounts.userprofile': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'tyrion_profile'", 'unique': 'True', 'to': u"orm['auth.User']"})
        },
        u'auth.group': {
